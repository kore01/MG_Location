...
class TeacherSchedule : BaseActivity(), Observer {
   ...
   // var classes: ArrayList<Classes> = ArrayList()
    ...
    override fun onStart() {
        super.onStart()
        var b = intent.extras
        var RoomName = b.getString("pos")
        //Log.i("roomname", RoomName)
        //Toast.makeText(this, RoomName, Toast.LENGTH_LONG)

        ClassesModel
        ClassesModel.addObserver(this)

        classes = ClassesModel.getDataForTeachers(RoomName!!) as ArrayList<Classes>
        ...
        teachers= getData()!!
        info.text=teachers[RoomName!!.toInt()-1].subject1
        namet.text=teachers[RoomName.toInt()-1].name + " " + teachers[RoomName.toInt()-1].familyname
        //val roomnametext: TextView = findViewById(R.id.RoomNamee)
        //roomnametext.text = RoomName
        nullpol()
        makeclasses()
        ...
        smqna.setOnClickListener{
            ...
            val intent = Intent(this, TeacherSchedule2::class.java)
            intent.putExtra("pos", RoomName)
...
//        ChooseTeacher(this)
    ...
    fun makeclasses() {
        ...
        for (a in classes) {
            Log.i("roomnumber", "The roomnymber right now is " + a.teachernumber)
            Log.i("teacher", "The teacher right now is " + RoomName)
            if (a.teachernumber == RoomName) {
                ...
                if (a.day == "Wednesday") {
                    ...
                    if (time1 <= 450 && time2 > 470) {
                        sr1!!.text = strings(sr1!!.text.toString(), a)
                    }
                    if (time1 < 520 && time2 > 520) {
